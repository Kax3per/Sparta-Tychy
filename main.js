...
// TRENINGI 
function showNewContent(cardNumber) {
    document.getElementById('originalContent' + cardNumber).style.display = 'none';
    document.getElementById('newContent' + cardNumber).style.display = 'block';
}

function showOriginalContent(cardNumber) {
